...
export default async function NewsArticlePage({
  ...
  return (
    <main className="flex min-h-screen flex-col bg-cream text-ink">
      ...
      <article className="mx-auto w-full max-w-3xl flex-1 px-5 py-10 lg:px-8 lg:py-14">
        <Link href="/naujienos" className="text-sm font-bold text-muted hover:text-ink">
          ← Visos naujienos
        </Link>

        <div className="mt-4 flex items-center gap-2 text-[12px] font-semibold uppercase tracking-wide text-muted">
